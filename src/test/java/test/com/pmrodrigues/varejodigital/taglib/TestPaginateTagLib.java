...
import com.pmrodrigues.varejodigital.taglib.PaginateTagLib;
...
public class TestPaginateTagLib {
    ...
    public void doTag() throws Exception {
        ...
        final String EXPECTED = "<div class=\"row\">" +
                ...
                "<a href=\"/varejodigital/loja/pesquisar.do?page=0\">&lt;&lt;</a>" +
                "</li>" +
                "<li class=\"paginate_button\" tabindex=\"0\">" +
                "<a href=\"/varejodigital/loja/pesquisar.do?page=0\">1</a>" +
                "</li>" +
                "<li class=\"paginate_button\" tabindex=\"1\">" +
                "<a href=\"/varejodigital/loja/pesquisar.do?page=1\">2</a>" +
                "</li>" +
                "<li class=\"paginate_button\" tabindex=\"2\">" +
                "<a href=\"/varejodigital/loja/pesquisar.do?page=2\">3</a>" +
                "</li>" +
                "<li class=\"paginate_button next \" aria-controls=\"dataTables-example\" tabindex=\"0\" id=\"dataTables-example_next\">" +
                "<a href=\"/varejodigital/loja/pesquisar.do?page=1\">&gt;&gt;</a>" +
                "</li>" +
                "</ul>" +
                "</div>" +
                "</div>" +
    ...
    public void botaoNextHabilitado() {
        ...
        final String EXPECTED =
                "<li class=\"paginate_button next \" aria-controls=\"dataTables-example\" tabindex=\"0\" id=\"dataTables-example_next\">" +
                        "<a href=\"/varejodigital/loja/pesquisar.do?page=2\">&gt;&gt;</a>" +
                        "</li>";
    ...
    public void botaoNextDesabilitado() throws Exception {
        ...
        final String EXPECTED =
                "<li class=\"paginate_button next disabled\" aria-controls=\"dataTables-example\" tabindex=\"0\" id=\"dataTables-example_next\">" +
                        "<a href=\"/varejodigital/loja/pesquisar.do?page=3\">&gt;&gt;</a>" +
                        "</li>";
    ...
    public void testaMontagemsDaPaginacaoCentral() {
        ...
        for (int i = 0; i < 10; i++) {
            EXPECTED.append(String.format("<li class=\"paginate_button\" tabindex=\"%s\"><a href=\"/varejodigital/loja/pesquisar.do?page=%s\">%s</a></li>", i, i, i + 1));
        }
