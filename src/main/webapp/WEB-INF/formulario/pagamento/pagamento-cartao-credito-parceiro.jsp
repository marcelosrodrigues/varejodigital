...
<div class="well bs-component col-lg-8">
	<form method="post" class="form-horizontal" action="pagar-assinatura.html">
		<fieldset>
			...
			<input type="hidden" name="ordempagamento.contrato.franqueado.razaoSocial"  value="${ordempagamento.contrato.franqueado.nomeFantasia}" />
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<label class="control-label">${ordempagamento.contrato.franqueado.razaoSocial}</label>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<label class="control-label">${ordempagamento.contrato.franqueado.CNPJ}</label>
				</div>
			</div>
