...
INSERT INTO usuario (bloqueado, email, password, cpf, dataNascimento, bairro, cep, cidade, complemento, logradouro, numero, nomeCompleto, estado_id, celular_id)
  VALUES (0, 'marcelosrodrigues@globo.com', md5('12345678'), '070.323.277-02', '1977-08-17',
...
VALUES (0, 'barbara@projetandoo.com.br', md5('12345678'), '', CURRENT_DATE(),'PECHINCHA', '-', 'RIO DE JANEIRO', '-', '-', '-', 'BARBARA', 330);