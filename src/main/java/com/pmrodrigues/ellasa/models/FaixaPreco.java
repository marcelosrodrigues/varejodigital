...
@NamedQueries({@NamedQuery(name = "FaixaPreco.All", query = "SELECT f FROM FaixaPreco f inner join fetch f.destino ORDER BY f.origem.uf, f.destino.uf , f.inicial , f.termino")})
