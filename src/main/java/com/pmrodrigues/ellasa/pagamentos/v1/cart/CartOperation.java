...
public class CartOperation extends AkatusOperation {
     ...
     *
     * @param product é uma instância de {@link Product} que será adicionada ao
     *                carrinho.
     */
     ...
     * @param quantity    é um {@link Integer} com a quantidade comprada pelo cliente.
     * @param shipping    é um {@link Double} com o preço do frete do produto.
     * @param discount    é um {@link Double} com um desconto para o produto.
     * @return A instância de {@link Product} que foi adicionada ao carrinho.
     */
    public Product addProduct(String code, String description, Double price,
    ...
    /**
     * @param payer é a instância de {@link Payer} com os dados do cliente.
     */
