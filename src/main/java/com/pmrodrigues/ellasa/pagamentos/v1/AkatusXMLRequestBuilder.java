...
public abstract class AkatusXMLRequestBuilder extends
     ...
     *
     * @param elementName é uma {@link String} com o nome do elemento que será criado.
     * @param textContent é uma {@link String} com o conteúdo texto do elemento que será
     *                    criado.
     ...
     *
     * @param elementName é uma {@link String} com o nome do elemento que conterá os nós
     *                    api_key e email.
     * @param operation   é a {@link AkatusOperation} que está solicitou a construção do
     *                    XML da requisição.
